...
def main(_):
  ...
  with gfile.FastGFile(FLAGS.output_labels, 'w') as f:
    ...
    ground_truth = tf.constant(np.asarray(test_ground_truth))
    ground_truth_array = sess.run(tf.argmax(ground_truth, 1))
    confusionMatrix = confusion_matrix(ground_truth_array, predictions)
