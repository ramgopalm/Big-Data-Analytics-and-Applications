...
public class ClarifaiExample {
    public static void main(String[] args) throws IOException {
        ...
        final ClarifaiClient client = new ClarifaiBuilder("idr3a0GhMKJR9PscnFnp0m7KFtwvXid-7fWdH8Pl", "NXCZL5MCP5aN1NZWxSmFx7IP4dsoMY7oiQAAP2Be")
        ...
        ClarifaiResponse response = client.getDefaultModels().generalModel().predict()
                .withInputs(
                        ClarifaiInput.forImage(ClarifaiImage.of(new File("input/trump.jpg")))
                )
                .executeSync();
        ...
        if (predictions.isEmpty()) {
            ...
            MBFImage image = ImageUtilities.readMBF(new File("input/trump.jpg"));
